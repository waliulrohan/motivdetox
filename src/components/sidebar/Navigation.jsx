...
import { BrainCircuit, ChartBarIcon, ChartPie, ClipboardList, SquareStack, UsersIcon } from "lucide-react"
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <NavigationLink name="Task Manager" hrefPath="taskmanager" isOpen={isOpen}>
            <ClipboardList className="stroke-inherit stroke-[1.7] min-w-8 w-8" />
          </NavigationLink>
