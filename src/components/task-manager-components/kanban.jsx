...
export const Kanban = () => {
  ...
  return (
    <section
      className="min-h-full max-h-full max-w-full bg-transparent pt-3 pb-32 overflow-auto"
      style={{
        backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32' fill='none' stroke-width='2' stroke='%2318181b'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e")`,
      }}
    >
      <div className="mx-auto w-full h-full max-w-xl px-4">
        <Header />
        <Todos
...
const Form = ({ setTodos }) => {
  ...
  return (
    <div className="fixed bottom-6  w-[calc(100vw-3rem)] right-0  px-4">
      <AnimatePresence>
        {visible && (
          <motion.form
